...
document.addEventListener(DELETED_EVENT, () => {
  const elementCustomAlert = document.createElement("div");
  elementCustomAlert.classList.add("alert");
  elementCustomAlert.innerText = "Deleted";
...
const makeBookElement = (bookObject) => {
  ...
  if (bookObject.isComplete) {
    ...
    returnBtn.innerHTML = `<button type="submit" class="kembalikan-btn">Belum selesai</button>`;
    ...
    deleteBtn.innerHTML = `<button type="submit" class="hapus-btn">Hapus</button>`;
    ...
    finishBtn.innerHTML = `<button type="submit" class="selesai-btn">Selesai</button>`;
